...
set(MUPARSER_ROOT_DIR "${MUPARSER_ROOT_DIR}"  CACHE PATH "Directory to search for mmuparser" )

find_package(PkgConfig QUIET)
if( PkgConfig_FOUND )
  pkg_search_module(PC_MUPARSER QUIET muparser)
  if( PC_MUPARSER_FOUND )
    set( MUPARSER_VERSION ${PC_MUPARSER_VERSION} )
  endif()
endif()
