...
TeXTableSettingsWidget::TeXTableSettingsWidget(QWidget *parent) : QWidget(parent)
{
    ...
    auto *alignGroupBox = new QGroupBox(tr("TeX table columns alignment"), this);
    ...
    auto *alignBoxLayout = new QHBoxLayout;
...
TeXTableSettings TeXTableSettingsWidget::settings()
{
