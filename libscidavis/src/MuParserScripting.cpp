...
const MuParserScripting::mathFunction MuParserScripting::math_functions[] = {
    ...
    { _T("w0"), 1, lambert_W0, NULL, NULL,
      QT_TR_NOOP("w0(x):\n Compute the principal branch of Lambert's W function, W_0(x).\n W is "
                 ...
                 "see wm1(x)).") },
    { _T("wm1"), 1, lambert_Wm1, NULL, NULL,
